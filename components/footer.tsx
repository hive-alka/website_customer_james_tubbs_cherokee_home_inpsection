      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-zinc-300 mb-6 text-lg leading-relaxed">{businessInfo.tagline}</p>
            <div className="space-y-4">
              <div className="flex items-center group">
                <div className="bg-blue-500/20 p-3 rounded-full mr-4 group-hover:scale-110 transition-transform">
                  <MapPin className="h-5 w-5 text-blue-400" />
                </div>
                <span className="text-zinc-300">{businessInfo.address.full}</span>
              </div>
              <div className="flex items-center group">
                <div className="bg-blue-500/20 p-3 rounded-full mr-4 group-hover:scale-110 transition-transform">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                ...
                >
                  <Facebook className="h-5 w-5 text-blue-400 group-hover:text-zinc-400" />
                </a>
                <a
                  ...
                  className="group bg-blue-500/20 p-3 rounded-full hover:bg-blue-500/30 transition-all duration-300 hover:scale-110"
                >
                  <Linkedin className="h-5 w-5 text-blue-400 group-hover:text-zinc-400" />
                </a>
                <a
                  ...
                  className="group bg-blue-500/20 p-3 rounded-full hover:bg-blue-500/30 transition-all duration-300 hover:scale-110"
                >
                  <Instagram className="h-5 w-5 text-blue-400 group-hover:text-zinc-400" />
                </a>
                <a
                  href="#"
                  target="_blank"
                  ...
                  className="group bg-blue-500/20 p-3 rounded-full hover:bg-blue-500/30 transition-all duration-300 hover:scale-110"
                >
                  <Edit className="h-5 w-5 text-blue-400 group-hover:text-zinc-400" />
                </a>
              </div>
            </div>
          </div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={index}>
                  <Link
                    href="/services"
                    className="text-zinc-300 hover:text-white transition-colors hover:translate-x-1 transform inline-block"
                  >
                    {service}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <p className="text-sm text-zinc-300 leading-relaxed">{businessInfo.serviceAreas.join(", ")}</p>
            </div>
          </div>
        </div>
                ...
                {certifications.certifications.map((cert, index) => (
                  <div key={index} className="text-center group">
                    <div className="bg-white/10 p-4 rounded-xl mb-3 group-hover:bg-white/20 transition-colors">
                      <div className="text-xs text-zinc-300 font-medium">{cert.name}</div>
        ...
        <div className="border-t border-white/20 pt-8 text-center">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-zinc-300">
              &copy; {new Date().getFullYear()} {businessInfo.name}. Powered by <a href="https://www.hiveinspect.com/" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-white transition-colors underline">Hive</a> - AI Copilot for Home Inspectors.
            </p>
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm text-zinc-300">{certifications.insurance.liability} Coverage</span>
              </div>
            </div>
          </div>
        </div>
