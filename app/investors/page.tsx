      ...
      <section className="animated-bg text-white py-32 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-zinc-100 max-w-4xl mx-auto leading-relaxed mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-white text-zinc-900 hover:bg-zinc-50 px-8 py-4 rounded-none font-medium tracking-wide transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {specializedServices.map((service, index) => (
              ...
              >
                {/* Service Image */}
                <div className="relative h-48 w-full overflow-hidden bg-gradient-to-br from-zinc-100 to-zinc-200">
                  {service.image ? (
                    <Image
                      src={service.image}
                      alt={service.title}
                ...
                <CardHeader className="pb-4">
                  <CardTitle className="text-xl text-zinc-900 group-hover:text-blue-700 transition-colors">
                    {service.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-zinc-50 rounded-full flex items-center justify-center shadow-sm">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-6 -right-6 bg-white p-6 shadow-xl border border-zinc-100 rounded-xl">
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">25%</div>
                  <div className="text-sm text-zinc-600">Average ROI Improvement</div>
                </div>
              </div>
            </div>
          </div>
